// https://github.com/yosevu/react-content-script/blob/main/scripts/postbuild.js
    ...
    content_scripts: [
        {
            ...
            js: [js],
            css: [css].filter((file) => file),
        },
    ],
    web_accessible_resources: [
        {
            ...manifest.web_accessible_resources[0],
            resources: [css, logo].filter((file) => file),
        },
    ],
}
